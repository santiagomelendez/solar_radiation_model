deploy: lib-hdf5 lib-netcdf4 pip-aspects
	sudo ldconfig
...
pip-aspects:
	...
	easy-install https://pypi.python.org/packages/2.5/p/python-aspects/python_aspects-1.1-py2.5.egg#md5=a99122b2294d12bac84f67e6029331b9
