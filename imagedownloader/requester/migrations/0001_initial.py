...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'requester_utctimerange', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.create_table(u'requester_automaticdownload', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.create_table(u'requester_automaticdownload_channels', (
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'requester_utctimerange')
        ...
        db.delete_table(u'requester_automaticdownload')
