...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CollectTimed.yearly'
        db.add_column('plumbing_collecttimed', 'yearly',
        ...
        # Adding field 'CollectTimed.weekly'
        db.add_column('plumbing_collecttimed', 'weekly',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CollectTimed.yearly'
        db.delete_column('plumbing_collecttimed', 'yearly')

        # Deleting field 'CollectTimed.monthly'
        db.delete_column('plumbing_collecttimed', 'monthly')

        # Deleting field 'CollectTimed.weekly'
        db.delete_column('plumbing_collecttimed', 'weekly')
