...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CollectTimed.process_ptr'
        db.delete_column('plumbing_collecttimed', 'process_ptr_id')

        # Adding field 'CollectTimed.collect_ptr'
        db.add_column('plumbing_collecttimed', 'collect_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['plumbing.Collect'], unique=True, primary_key=True),
                      keep_default=False)

        # Deleting field 'CollectChannel.process_ptr'
        db.delete_column('plumbing_collectchannel', 'process_ptr_id')

        # Adding field 'CollectChannel.collect_ptr'
        db.add_column('plumbing_collectchannel', 'collect_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['plumbing.Collect'], unique=True, primary_key=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'CollectTimed.process_ptr'
        raise RuntimeError("Cannot reverse this migration. 'CollectTimed.process_ptr' and its values cannot be restored.")
        # Deleting field 'CollectTimed.collect_ptr'
        db.delete_column('plumbing_collecttimed', 'collect_ptr_id')

        # Adding field 'CollectChannel.process_ptr'
        db.add_column('plumbing_collectchannel', 'process_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['plumbing.Process'], unique=True, primary_key=True),
                      keep_default=False)

        # Deleting field 'CollectChannel.collect_ptr'
        db.delete_column('plumbing_collectchannel', 'collect_ptr_id')
