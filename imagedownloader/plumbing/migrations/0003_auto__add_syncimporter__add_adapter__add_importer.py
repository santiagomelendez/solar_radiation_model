...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('plumbing_syncimporter', (
            ('importer_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['plumbing.Importer'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('plumbing', ['SyncImporter'])

        # Adding model 'Adapter'
        db.create_table('plumbing_adapter', (
        ...
        db.create_table('plumbing_importer', (
            ('adapter_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['plumbing.Adapter'], unique=True, primary_key=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('plumbing_syncimporter')

        # Deleting model 'Adapter'
        db.delete_table('plumbing_adapter')

        # Deleting model 'Importer'
        db.delete_table('plumbing_importer')
    ...
    models = {
        ...
        'plumbing.importer': {
            ...
            'adapter_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['plumbing.Adapter']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        'plumbing.syncimporter': {
            ...
            'importer_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['plumbing.Importer']", 'unique': 'True', 'primary_key': 'True'})
        },
        'plumbing.tagmanager': {
