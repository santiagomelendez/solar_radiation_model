...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AppendCountToRadiationCoefficient.calibrated_coefficient'
        db.delete_column('plumbing_appendcounttoradiationcoefficient', 'calibrated_coefficient')

        # Deleting field 'AppendCountToRadiationCoefficient.counts_shift'
        db.delete_column('plumbing_appendcounttoradiationcoefficient', 'counts_shift')

        # Deleting field 'AppendCountToRadiationCoefficient.space_measurement'
        db.delete_column('plumbing_appendcounttoradiationcoefficient', 'space_measurement')


    def backwards(self, orm):
        # Adding field 'AppendCountToRadiationCoefficient.calibrated_coefficient'
        db.add_column('plumbing_appendcounttoradiationcoefficient', 'calibrated_coefficient',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=5, decimal_places=3),
                      keep_default=False)

        # Adding field 'AppendCountToRadiationCoefficient.counts_shift'
        db.add_column('plumbing_appendcounttoradiationcoefficient', 'counts_shift',
                      self.gf('django.db.models.fields.IntegerField')(default=0.0),
                      keep_default=False)

        # Adding field 'AppendCountToRadiationCoefficient.space_measurement'
        db.add_column('plumbing_appendcounttoradiationcoefficient', 'space_measurement',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=5, decimal_places=3),
                      keep_default=False)
