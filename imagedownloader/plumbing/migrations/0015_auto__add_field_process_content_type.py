...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Process.content_type'
        db.add_column('plumbing_process', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(null=True, related_name=u'+', to=orm['contenttypes.ContentType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Process.content_type'
        db.delete_column('plumbing_process', 'content_type_id')
