...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Sensor.optic_filter'
        db.alter_column('station_sensor', 'optic_filter_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['station.OpticFilter'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Sensor.optic_filter'
        raise RuntimeError("Cannot reverse this migration. 'Sensor.optic_filter' and its values cannot be restored.")
    ...
    models = {
        ...
        'station.configuration': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 13, 0, 0)'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 13, 0, 0)'}),
        ...
        'station.measurement': {
            ...
            'finish': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 13, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'station.sensor': {
            ...
            'device_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['station.Device']", 'unique': 'True', 'primary_key': 'True'}),
            'optic_filter': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['station.OpticFilter']", 'null': 'True'})
        },
